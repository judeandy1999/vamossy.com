  ...
  authorStatements: [
    {
      id: "god-infra",
      quote: "god infra",
      note: "The author's term for the overall concept.",
    },
    {
      id: "scientifically-proven",
      quote: "all proven / proven scientifically",
      note: "The author's claim about the seven layers. This site does not independently validate, endorse, or restated that claim as established fact. Supporting evidence has not yet been supplied for this page.",
    },
    {
      id: "agi",
      quote: "I made AGI",
      note: "A statement from the author. It is not presented here as an independently established fact.",
    },
    {
      id: "prep",
      quote: "I'll need 1 month prep",
      note: "The preparation window stated by the author.",
    },
  ],
  relatedResearch: [
    {
