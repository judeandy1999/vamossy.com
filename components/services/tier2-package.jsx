  ...
  return (
    <Container variant="transparent-gradient">
      <div className="max-w-7xl px-4 sm:px-6 lg:px-8">
        <Container variant="gray-gradient" className="border border-yellow-400/80 hover:border-yellow-400 transition-colors duration-300 rounded-2xl shadow-2xl">
