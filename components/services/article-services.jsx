...
export default function ServicesLiveCaseStudies() {
  const titleVariants = {
  ...
  return (
    <section className="relative min-h-screen py-20 px-4 bg-transparent">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-shadow-sm text-xl md:text-5xl lg:text-6xl font-semibold text-gray-100">
            {liveCaseStudies.title}
          </h2>
          <p className="text-shadow-sm mx-auto text-md md:text-xl lg:text-2xl mt-4 font-light text-gray-200 mb-8 max-w-5xl">
            {liveCaseStudies.subtitle}
          </p>
        </motion.div>
