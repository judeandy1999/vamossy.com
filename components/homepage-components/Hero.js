    ...
    <section className="bg-gradient-to-br from-[#f3f6f9] to-[#f1f6fe] h-auto min-h-[90dvh] flex w-full px-4 py-8 md:py-0">
      <div className="max-w-7xl mx-auto my-auto flex flex-col md:flex-row items-center md:justify-between w-full relative">
        <div className="max-w-xl w-full">
          <h1 className="text-3xl text-[#1e283c] md:text-[55px] font-bold leading-tight mb-4 md:mb-6">
            Ecommerce Growth, Without the Guesswork <span className="text-[#1f40af]">Find Your Perfect Ecommerce Agency</span> + <span className="text-[#3c82f6]">Embed AI That Delivers ROI</span>
          </h1>
          <p className="text-base md:text-md text-[#505a66] mb-6 md:mb-8">
            Finding the right ecommerce agency shouldn’t feel like gambling. Vamossy connects you with vetted partners and embeds AI solutions designed to deliver measurable ROI—independent, transparent, and built to scale.
          </p>
          <div className="flex flex-col md:flex-row gap-3 md:gap-4 mb-6 md:mb-8 w-full md:pb-8">
            <button className="cursor-pointer border border-[#1f40af] text-[#1f40af] font-semibold py-3 px-6 rounded-lg hover:scale-105 transition-transform duration-200 flex items-start justify-center w-full md:w-auto">
              <User className="w-5 h-5 mr-2" />
              Find My Agency Match
            </button>
            <button
          ...
          <div className="md:absolute md:bottom-4 flex flex-col sm:flex-row gap-4 md:gap-8 text-sm text-[#505a66] mt-2 md:mt-4">
            ...
            <div className="flex items-center gap-2">
              <CalendarCheck className="w-4 h-4 text-[#1f40af]" />
              Results in 30 Days
            </div>
            <div className="flex items-center gap-2">
