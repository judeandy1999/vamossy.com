...
export default function LetsBuild() {
    ...
    return (
        <Container className='!bg-gradient-to-r from-[#1a1f35] via-[#20263a] to-[#1a1f35]'>
            ...
            <div className="relative flex flex-col justify-center items-center min-h-[20vh] w-full px-6 py-8 z-10">
                ...
                <div className="max-w-7xl mx-auto w-full relative z-10">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 lg:gap-12">
                        <div className="flex-1 relative lg:pr-10">
                            ...
                            <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-white leading-tight mb-4 tracking-tight">
                                Let's Build Smart Growth Systems Together
                            </h2>
                            <p className="text-base sm:text-lg lg:text-xl text-gray-200 leading-relaxed font-medium max-w-4xl mb-6 lg:mb-0">
                        ...
                        <div className="flex-shrink-0 w-full lg:w-auto">
                            <div className="relative">
                                ...
                                <HeroButton
                                    ...
                                    icon={Check}
                                    delay={0.2}
                                    className="relative w-full lg:w-[320px] text-base font-bold shadow-2xl hover:shadow-yellow-400/25 border-yellow-400/50 hover:border-yellow-400"
                                >
