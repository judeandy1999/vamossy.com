          ...
          {bookingMethod === 'single' ? (
            ...
            <div className="max-w-2xl mx-auto">
              <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
                ...
                >
                  {canBook ? 'Select Date & Time' : 'Purchase & Book'}
                </button>
              </div>
            </div>
          ) : (
            /* Multiple Bookings Section - Same as before */
            <div className="max-w-2xl mx-auto">
              <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
                <div className="text-center mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {bookingMethod === 'single' 
                    ...
                    : `${selectedCredits} consultation sessions you can book anytime`
                  }
                </p>
              </div>
              <div className="text-right">
            ...
            {bookingMethod === 'multiple' && (
              <div className="mt-4 pt-4 border-t border-gray-200">
                <p className="text-sm text-gray-600 mb-2">
                  <strong>Next step:</strong> After payment, you'll receive {selectedCredits} consultation credits and can book your sessions.
                </p>
                <button
                  onClick={handleBookAfterPayment}
